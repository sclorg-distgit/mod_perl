...
Version:        2.0.8
Release:        5.20130221svn1448242.sc1%{?dist}
...
%filter_from_provides /perl(UNIVERSAL)/d; /perl(DB)/d; /perl(warnings)/d; /HTTP::Request::Common)/d
%filter_provides_in %{_docdir}
%filter_provides_in %{_httpd24_moddir}
%filter_requires_in %{_docdir}
%filter_from_requires /perl(Apache2::FunctionTable)/d
%filter_from_requires /perl(Apache2::StructureTable)/d
%filter_from_requires /perl(Apache::Test.*)/d
%filter_from_requires /perl(Data::Flow)/d
%filter_from_requires /perl(Module::Build)/d
%filter_from_requires /perl(Apache2::MPM)/d
%filter_setup
}
...
%changelog
* Tue Mar 25 2014 Jan Kaluza <jkaluza@redhat.com> - 2.0.8-5.20130221svn1448242
- own include directories in -devel subpackage (#1079938)
- depend on httpd-2.4 in -devel subpackage

* Thu Feb 13 2014 Jan Kaluza <jkaluza@redhat.com> - 2.0.8-4.20130221svn1448242
- do not enable mod_perl with event MPM (#1059225) 

* Fri Jan 24 2014 Jan Kaluza <jkaluza@redhat.com> - 2.0.8-3.20130221svn1448242
- filter out Apache-test and other no-runtime modules from requires (#1057175)

* Fri Jan 24 2014 Jan Kaluza <jkaluza@redhat.com> - 2.0.8-2.20130221svn1448242
- remove private shared libraries from provides (#1057175)
